...
export default class Router {
  ...
  findAllResources(req, res) {
    ...
    // FIXME: remove hardcoded pets and add query, pagination, etc
    Model.find(query, {}, pagination)
      ...
      .exec((err, resources) => {
        ...
        //console.log(prettyjson.render(serializer.serializeResponse(this, 'get', type, resources)));
  ...
  findResource(req, res) {
    ...
    Model.findById(id)
      ...
      .exec((err, resource) => {
        ...
        //console.log(prettyjson.render(serializer.serializeResponse(this, 'get', type, resource)));
